                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" valign="top"
                                    style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background-color:#fff;border-bottom:4px solid #771818;text-align:center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px">
                                                    <div>
                                                        Greetings from contentwritingservice.ae,
                                                        <br>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <br>Thank you for choosing contentwritingservice.ae,
                                                        <br>
                            ...
                            <tr bgcolor="#fff" style="border-top:4px solid #771818">
