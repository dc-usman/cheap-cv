                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">{{ trans('cruds.service.title') }}</h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" >
                                                <a href='{{ route('admin.services.show', [$service->slug]) }}' target="_blank" service='button' class='btn btn-sm btn-primary'> <i class='bi bi-eye' ></i> </a>
