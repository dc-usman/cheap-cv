                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }} get-slug" type="text" name="title" id="title" value="{{ old('title', '') }}" >
                                    @if($errors->has('title'))
                                ...
                                <div class="mb-3 {{ $errors->has('tags') ? 'has-error' : '' }}">
                                    <label for="tag">{{ trans('cruds.blog.fields.image') }}</label>
                                ...
                                <div class="mb-3">
                                    <textarea class="ckeditor form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" rows="10" id="editor" name="description">{{ old('description') }}</textarea>
            ...
            $(".get-slug").on("change", function() {
                ...
                $.ajax({
                    ...
                    success: function(res){
                        console.log(res)
                        $('#slug').val(res);
                        $('#canonical').val('https://writingservice.com.pk/'+res);
                    },
                    error: function(res) {
