                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">{{ trans('cruds.setting.title') }}</h5>
                                    <a href="{{ route('admin.web-setting.edit', $setting->id) }}" class="btn btn-sm btn-info my-auto"> {{ trans('global.edit') }} {{ trans('cruds.setting.title_singular') }} </a>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            {{ trans('cruds.setting.fields.whatsapp_no') }}
                                        </th>
                                        <td>
                                            {{ $setting->whatsapp_no ?? '-' }}
                                        </td>
